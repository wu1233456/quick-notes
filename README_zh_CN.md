...
## 更新日志
### 1.1.4 (2025-01-12)
- 新增将flomo笔记同步到小记的能力（这部分工作是参考集市已有插件[浮墨同步](https://github.com/winter60/plugin-flomo-sync)的功能，感谢作者的贡献，我基本只是相当于集成进来而已）

### v1.1.3 (2025-01-12)
- 修复小记侧边栏启动时偶尔无法加载的问题

### v1.1.2 (2025-01-11)
- 新增系统级提醒功能，即使思源处于最小化状态，也能收到提醒。支持设置提醒时间，支持清除提醒。
- 新增插入模式的切换，可以选择一键将小记插入到今日笔记，或者插入到指定文档中。
- 优化历史小记到布局，将常用按钮移出更多选项中
- 新增将历史小记生成分享图的能力
...
## 感谢
- 感谢[浮墨同步](https://github.com/winter60/plugin-flomo-sync)插件的作者，我参考了其代码，实现了将flomo笔记同步到小记的能力
- 感谢f佬编写的[插件开发 Quick Start](https://ld246.com/article/1723732790981#%E8%A7%A3%E6%9E%90-markdown-%E6%96%87%E6%9C%AC)，让我快速上手了思源插件开发


## 支持
如果这个插件对你有点帮助，可以考虑给我一个小小的赞赏表示支持 ❤️ ，金额多少不重要，这是对我的一种鼓励，非常感谢大家！
